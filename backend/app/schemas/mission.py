...
class BsfBriefingOut(AGRIOSSchema):
    """Mission Control's strategic BSF briefing — same shape as the aviculture one
    so Mission Control consumes every module's briefing identically."""
...
class SwineBriefingOut(AGRIOSSchema):
    """Mission Control's strategic swine briefing — same shape as the other module
    briefings so Mission Control consumes every module identically."""
